...
public class Pile2Test extends junit.framework.TestCase {
    ...
    public void test_methode() throws Exception{
        ...
        pile2.empiler("5");
        pile2.empiler("6");
        assertTrue("la pile est pleine? :" , pile2.estPleine());
        pile2.depiler();
        assertTrue("la pile contient maintenant 5?",pile2.taille()==5);
        assertTrue("Capacite initiale est:", pile2.capacite()==6);
        assertTrue("Sommet est:",pile2.sommet().toString().equals("5"));
        
    }
    
    public void test_to_string() throws Exception{
        test_methode();
        String sommet = (String) pile2.depiler();
        assertTrue("le sommet etait: ",pile2.sommet().toString().equals("4"));
        assertTrue("Representation de la pile est :",
        pile2.toString().equals("[4,3,2,1]"));
    }
}
